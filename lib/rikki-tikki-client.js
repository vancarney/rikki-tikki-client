...
(function() {
  var Backbone, RikkiTikki, _, global;
    ...
    RikkiTikki = global.RikkiTikki = (function() {
      ...
      return app = {
        createScope: function(ns, schema) {
          ...
          return _.extend(new _appLayer(ns), $extend, {
            namespace: ns,
            schema: schema
          });
        },
