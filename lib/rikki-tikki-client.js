...
(function() {
  var APIHero, Backbone, Namespace, SchemaRoller, _, __schema__, _global, _sr, ref,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;

  _global = (ref = module.exports) != null ? ref : window;

  _ = _global._ || (typeof exports !== 'null' ? require('lodash') : null);

  Backbone = _global.Backbone || (typeof exports !== 'null' ? require('backbone') : null);

  Backbone.$ = _global.jQuery || (typeof exports !== 'null' ? require('jquery') : null);
...
(function() {
  ...
  if (!_global.APIHero) {
    APIHero = _global.APIHero = (function() {
      var $extend, __defaults__, _appLayer, _local, app, createScope;
      $extend = {};
      _local = {};
      __defaults__ = {
        __COLLECTIONS__: {},
      ...
      _appLayer = function(ns) {
        ...
        $scope.getAPIUrl = function() {
          var _host, _path, _pcl, _port, _vers;
        ...
        $scope.querify = function(obj) {
          return (_.map(_.toPairs(obj || {}), (function(_this) {
            return function(v, k) {
              return v.join('=');
            };
          })(this))).join('&');
        ...
        $scope.Singleton = (function(superClass) {
          extend(Singleton, superClass);
        
          function Singleton() {
            var _caller, _caller_super, cName, isDescended, matchSig;
            cName = $scope.wf.wfUtils.Fun.getConstructorName(this);
        ...
        $scope.Object = (function(superClass) {
          ...
          function Object(attrs, opts) {
            ...
            if ((this.className != null ? this.className : this.className = $scope.wf.wfUtils.Fun.getConstructorName(this)) === $scope.UNDEFINED_CLASSNAME) {
            ...
            this.attributes = new $scope.SchemaRoller.Schema($scope.getCollection(this.className) || {
              extensbile: true,
              elements: {
                type: 'Object'
              }
            ...
            ((function(_this) {
              return function() {
                return typeof Object.seal === "function" ? Object.seal(_this) : void 0;
              };
            })(this))();
          }
        
          Object.prototype.validate = function(attrs, opts) {
            var j, k, len, path, ref1, v, validator;
            if (attrs == null) {
              attrs = {};
            }
            if (opts == null) {
          ...
          Object.prototype.sync = function(method, model, options) {
            ...
            opts.data = !this._query ? JSON.stringify(this.toJSON()) : $scope.QUERY_PARAM + "=" + (this._query.toJSON());
                ...
                return function(v, k) {
                  ...
                  if (_this.__schema.virtuals[k]) {
                    ...
                    if (v != null ? v.hasOwnProperty('_toPointer' && typeof v._toPointer === 'Function') : void 0) {
                      v = v._toPointer();
                      if (((ref1 = (oV = _this.get(k))) != null ? ref1.__op : void 0) != null) {
          ...
          Object.prototype._toFullJSON = function(seenObjects) {
            var json;
            _.each((json = _.clone(this.attributes.valueOf())), function(v, k) {
          ...
          Object.prototype.nestCollection = function(aName, nCollection) {
            var i, item, j, len;
            for (i = j = 0, len = nCollection.length; j < len; i = ++j) {
              item = nCollection[i];
        ...
        $scope.Object._getSubclass = function(className) {
          ...
          return (base1 = $scope.Object._classMap)[className] != null ? base1[className] : base1[className] = (clazz = $scope.Object._classMap[className]) ? clazz : $scope.Object.extend(className);
        };
        ...
        SchemaModel = (function(superClass) {
          extend(SchemaModel, superClass);
        ...
        $scope.Collection = (function(superClass) {
          ...
          Collection.prototype.sync = function(__method, model, options) {
            ...
            opts.data = !this.__query ? JSON.stringify(this.toJSON()) : $scope.QUERY_PARAM + "=" + this.__query;
          ...
          function Collection(attrs, opts) {
            ...
            this.model = (this.className != null ? this.className : this.className = $scope.getConstructorName(this)) === $scope.UNDEFINED_CLASSNAME ? console.warn(namespace + ".Collection requires className to be defined") : this.className = $scope.Inflection.pluralize(this.className);
            this.model = $scope.Object.extend({
              className: this.className
            });
            this.models = new $scope.SchemaRoller.Vector([$scope.Model]);
            this.__schema = new $scope.Schema(_.extend($scope.getSchema(this.className) || {}, this.schema, opts.schema || {}));
            ((function(_this) {
              return function() {
                return Object.seal(_this);
              };
            })(this))();
          }
          ...
          Collection.prototype.or = function() {
            var queries;
            queries = 1 <= arguments.length ? slice.call(arguments, 0) : [];
        ...
        $scope.Batch = (function(superClass) {
        ...
        $scope.User = (function(superClass) {
        ...
        $scope.Users = (function(superClass) {
        ...
        $scope.Login = (function(superClass) {
          ...
          Login.prototype.restore = function(token, options) {
            ...
            if ((type = typeof token) !== 'string') {
              throw "token expected to be type 'string' type was <" + type + ">";
            }
            return this.fetch(_.extend({}, options, {
              url: (this.url()) + "/restore/" + token,
              success: (function(_this) {
                return function() {
                  var ref1;
                  return (ref1 = options.success) != null ? ref1.apply(_this, arguments) : void 0;
        ...
        $scope.Auth = (function(superClass) {
          ...
          function Auth() {
            ...
            this.resetPassword = function(model, options) {
        ...
        $scope.VirtualType = (function(superClass) {
          extend(VirtualType, superClass);
          ...
          VirtualType.prototype.applyGetters = function(value, scope) {
            var idx, j, ref1, v;
            v = value;
            for (idx = j = ref1 = this.getters.length - 1; ref1 <= 0 ? j <= 0 : j >= 0; idx = ref1 <= 0 ? ++j : --j) {
              if (idx === -1) {
                break;
              }
          ...
          VirtualType.prototype.applySetters = function(value, scope) {
            var idx, j, ref1, v;
            v = value;
            for (idx = j = ref1 = this.setters.length - 1; ref1 <= 0 ? j <= 0 : j >= 0; idx = ref1 <= 0 ? ++j : --j) {
              if (idx === -1) {
                break;
              }
        ...
        $scope.Router = (function(superClass) {
        ...
        $scope.Schema = (function(superClass) {
        ...
        $scope.Schema.reserved = _.zipObject(_.map("on,db,set,get,init,isNew,errors,schema,options,modelName,collection,toObject,emit,_events,_pres,_posts".split(','), function(v) {
          return [v, 1];
        }));
        
        $scope.SchemaLoader = (function(superClass) {
          ...
          function SchemaLoader(opts) {
            ...
            this.schema = new $scope.SchemaRoller.Schema({
              elements: {
                __meta__: {
                  type: 'Object',
                  required: false,
        ...
        $scope.Query = (function() {
          ...
          function Query(classOrName) {
            if (classOrName != null) {
              ...
              this.className = this.objectClass.className || $scope.wf.wfUtils.Fun.getConstructorName(this.objectClass);
            }
            this.or = this._or;
            this["in"] = this._in;
            this.clear();
          ...
          Query.prototype._or = function() {
            var base1, queries;
            queries = 1 <= arguments.length ? slice.call(arguments, 0) : [];
            return this.__q['$or'] = ((base1 = this.__q)['$or'] != null ? base1['$or'] : base1['$or'] = []).concat($scope.Query.or(queries));
          };
      ...
      createScope = function(ns, config) {
        var _obj;
        if (global[ns]) {
          return global[ns];
        }
    ...
    Namespace = (function(superClass) {
      ...
      function Namespace(config) {
        Namespace.__super__.constructor.call(this, __schema__);
        this.getOptions = (function(_this) {
          return function(name) {
            return _this.get("__OPTIONS__" + (name != null ? '.' + name : ''));
          };
        })(this);
        this.setOptions = (function(_this) {
          return function(name, val) {
            switch (typeof name) {
              case 'string':
                return _this.set("__OPTIONS__." + name, val);
              case 'object':
                return _this.set('__OPTIONS__', name);
              default:
                throw "setOptions: invalid arguments given";
            }
          };
        })(this);
        this.listCollections = (function(_this) {
          return function() {
            return Object.keys(_this.get('__COLLECTIONS__'));
          };
        })(this);
        this.getCollection = (function(_this) {
          return function(name) {
            var _c, ref1;
            if ((ref1 = (_c = _this.get('__COLLECTIONS__'))) != null ? ref1.hasOwnProperty(name) : void 0) {
              return _c[name];
            } else {
              return null;
            }
        ...
        this.createCollection = function(schema) {
          return new this.Collection(schema);
        };
        this.addCollection = (function(_this) {
          return function(name, coll) {
            var _colls;
            if (name == null) {
              throw new ReferenceError("Required argument 'name' was not defined");
            }
            if ((_this.getCollection(name)) != null) {
              throw new ReferenceError("Collection '" + name + "' already exists");
            }
            _colls = _this.get('__COLLECTIONS__');
            _colls.set(name, _s || {});
            return _this[name] = _s;
          };
        })(this);
        this.removeCollection = (function(_this) {
          return function(name) {
            var _c, ref1;
            if (!((ref1 = (_c = _this.get('__COLLECTIONS__'))) != null ? ref1.hasOwnProperty(name) : void 0)) {
              return;
            ...
            delete _c[name];
            return _this.set('__COLLECTIONS__', _c);
          };
        })(this);
        if (config != null) {
          this.set(config);
