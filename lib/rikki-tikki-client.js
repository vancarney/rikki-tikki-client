      ...
      _appLayer = function(ns) {
        ...
        $scope.Object = (function(_super) {
          ...
          Object.prototype.url = function() {
            var p;
            return ($scope.getAPIUrl()) + "/" + (!$scope.CAPITALIZE_CLASSNAMES ? this.className.toLowerCase() : this.className) + (!this.isNew() ? '/' + (this.get(this.idAttribute)) : '') + ((p = $scope.querify(this.__op)).length ? '?' + p : '');
          };
          ...
          function Auth(token) {
            ...
            this.login = (function(_this) {
              return function(username, password, options) {
                return (login != null ? login : login = new $scope.Login).login(username, password, options);
              };
            })(this);
            ...
            this.setUser = (function(_this) {
              return function(attributes, options) {
                return user.set(attributes, options);
              };
            })(this);
            this.saveUser = (function(_this) {
              return function(attributes, options) {
                return user.save(attributes, options);
              };
            })(this);
            this.registerUser = (function(_this) {
              return function(attributes, options) {
                return _this.saveUser(attributes, options);
              };
            })(this);
            if (token != null) {
              this.restore(token);
