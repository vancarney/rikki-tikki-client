...
(function() {
  ...
  if (!global.RikkiTikki) {
    ...
    RikkiTikki.initialize = function(opts, callback) {
      ...
      return (this.schemaLoader = new this.SchemaLoader).fetch({
  ...
  RikkiTikki.Router = (function(_super) {
    ...
    function Router() {
      ...
      RikkiTikki.Router.routes = (function(_this) {
        return function(r) {
          return _router.routes(r);
        };
      })(this);
      RikkiTikki.Router.route = (function(_this) {
        return function(r, n, cB) {
          return _router.route(r, n, cB);
        };
      })(this);
      RikkiTikki.Router.navigate = (function(_this) {
        return function(p, opts) {
          return _router.navigate(p, opts);
        };
      })(this);
      RikkiTikki.Router.execute = (function(_this) {
